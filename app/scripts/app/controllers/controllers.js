  ...
  angular
    ...
    .controller("OverViewController", [
      ...
      function ($scope, clientInfo, ClientInfoService, PortService) {
        ...
        var unlistenCobrowse = PortService.onMessage(
          "cobrowseLoaded",
          function (data) {
            $scope.cobrowse = data;
          }
    ...
    .controller("RuleController", [
      ...
      function (ruleStates, $scope, ClientInfoService, PortService, $state) {
        ...
        self.getConditionTypeLabel = function (conditionType) {
          var label =
            ClientInfoService.output.ruleconditionTypes[conditionType];
          return label && label.replace(/_/g, " ");
        };
        ...
        var unlistenRules = PortService.onMessage("ruleStateChange", function (
          ruleStates
        ) {
          self.ruleStates = ruleStates;
        });
    ...
    .controller("RuleConditionController", [
      "$scope",
      "ClientInfoService",
      function ($scope, ClientInfoService) {
        var self = this;
        ...
        self.submitRuleCondition = function (ruleId, conditionIndex) {
          self.stopEditing();
          ClientInfoService.editRuleCondition(
            ruleId,
            conditionIndex,
            self.editedCondition.value,
            self.editedCondition.type
          ).then(function (ruleStates) {
